...
from Models.GNN.STDGNN import GNNTest
from Models.RNNs.RNNs import RNNModel
from Models.CNNs.InceptionTime import InceptionTime
from Models.Transformers.TimesNet import TimesNet
from Models.Transformers.PatchTST import PatchTST
...
class ExperimentConfig():
    ...
    def __init__(self, dataset, data=None, model=None, model_args=None, n_fold=None, i_fold=None):
        ...
        if model is not None:
            ...
            self.build_model()
            self._logkey = f"{self.datakey}/{model}"
