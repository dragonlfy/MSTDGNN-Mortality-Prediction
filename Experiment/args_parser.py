...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="mimic3", help="Config dataset")
    parser.add_argument(
        "--data",
        type=str,
    ...
    parser.add_argument("--model", type=str, default="gnntest", help="Config model key")
    ...
    for (net_args_str, opt_args_str), loss_args_str in product(
        product(
            args_generator(net_args_grid),
