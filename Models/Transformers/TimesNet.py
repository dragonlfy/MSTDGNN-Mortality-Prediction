...
class TimesNet(nn.Module):
    ...
    def __init__(self, seq_len, label_len, pred_len, e_layers, top_k, d_model, d_ff, num_kernels, enc_in, embed, freq, dropout, num_class):
